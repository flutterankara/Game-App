...
abstract class LayoutConstants {
  ...
  static const mighSize = 20.0;
  static const highSize = 24.0;
  static const largeSize = 32.0;
  static const laxSize = 40.0;
  static const maxSize = 48.0;
  static const ultraSize = 64.0;
  static const ultraSize80 = 80.0;
  static const ultraSize108 = 108.0;
  static const ultraSize176 = 176.0;
  ...
  // ************* Horizontal Padding ************* //
  static const buttonPadding = EdgeInsets.symmetric(horizontal: midSize, vertical: midSize);
  ...
  static const largeRadius = 22.0;
  static const maxRadius = 30.0;

  // ************* Circular Radius ************* //
  static const lowButtonBorder = BorderRadius.all(Radius.circular(lowRadius));
  ...
  static const largeButtonBorder = BorderRadius.all(Radius.circular(largeRadius));
